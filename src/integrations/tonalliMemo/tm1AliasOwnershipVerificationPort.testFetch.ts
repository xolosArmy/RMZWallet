/**
 * Test-only alias.ecash.mx fetch double. Not a production observer and
 * not a caller-supplied observe() lambda. App / routes / RegisterAlias /
 * orchestrator must not import this file.
 */
